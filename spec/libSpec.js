...
describe('ReportPortal javascript client', () => {
    ...
    xdescribe('mergeLaunches', () => {
        ...
        it('calls client', () => {
            ...
            spyOn(helpers, 'readLaunchesFromFile').and.returnValue(
                fakeLaunchIds,
            );
            spyOn(client, 'getMergeLaunchesData').and.returnValue(
                fakeMergeDataRQ,
            );
            ...
            ).toHaveBeenCalledWith('launch/merge', fakeMergeDataRQ, {
                headers: client.headers,
            });
        });
    });
    ...
    xdescribe('updateLaunch', () => {
        ...
        it('sends put request to update description for launch', () => {
            ...
            expect(
                client.helpers.getServerResult.calls.length,
